...
public class StudentController {
	...
	public String getCourse(@RequestParam("courseId") int courseId, Model model) {
	...
	/*
	 * @GetMapping(value = "/getAllCourseByEmail") public String
	 * getAllCourseByEmail(@RequestParam("email") String email, Model model) { Users
	 * user = us.findByEmail(email); List<Course> courses =
	 * sser.findAllCourseByUserId(user.getId()); model.addAttribute("course",
	 * courses); return "myCourse"; }
	 */
